...
@JsonKey(name: 'n') String get name;@JsonKey(name: 'v', toJson: _notesToJson, fromJson: _notesFromJson) Map<VerseSelection, String> get notes;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Commentary&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.notes, notes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,const DeepCollectionEquality().hash(notes));

@override
String toString() {
  return 'Commentary(name: $name, notes: $notes)';
}
...
@useResult
$Res call({
@JsonKey(name: 'n') String name,@JsonKey(name: 'v', toJson: _notesToJson, fromJson: _notesFromJson) Map<VerseSelection, String> notes
});
...
/// Create a copy of Commentary
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? notes = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'n')  String name, @JsonKey(name: 'v', toJson: _notesToJson, fromJson: _notesFromJson)  Map<VerseSelection, String> notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Commentary() when $default != null:
return $default(_that.name,_that.notes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'n')  String name, @JsonKey(name: 'v', toJson: _notesToJson, fromJson: _notesFromJson)  Map<VerseSelection, String> notes)  $default,) {final _that = this;
switch (_that) {
case _Commentary():
return $default(_that.name,_that.notes);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'n')  String name, @JsonKey(name: 'v', toJson: _notesToJson, fromJson: _notesFromJson)  Map<VerseSelection, String> notes)?  $default,) {final _that = this;
switch (_that) {
case _Commentary() when $default != null:
return $default(_that.name,_that.notes);case _:
  return null;
...
class _Commentary extends Commentary {
  const _Commentary({@JsonKey(name: 'n') required this.name, @JsonKey(name: 'v', toJson: _notesToJson, fromJson: _notesFromJson) required final  Map<VerseSelection, String> notes}): _notes = notes,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Commentary&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._notes, _notes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,const DeepCollectionEquality().hash(_notes));
...
/// Create a copy of Commentary
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? notes = null,}) {
