...
mixin _$User {
 ...
 BibleTranslation get translation; ChapterReference get lastReference; String? get currentBookmarkId; List<ChapterReference> get viewHistory; ColorEnum get highlightColor; Map<String, Bookmark> get bookmarkById; List<Annotation> get annotations; ToolbarConfiguration get toolbar; PassageConfiguration get passage; SelectionConfiguration get selection; List<String> get searchHistory;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,translation,lastReference,currentBookmarkId,const DeepCollectionEquality().hash(viewHistory),highlightColor,const DeepCollectionEquality().hash(bookmarkById),const DeepCollectionEquality().hash(annotations),toolbar,passage,selection,const DeepCollectionEquality().hash(searchHistory));

@override
String toString() {
  return 'User(translation: $translation, lastReference: $lastReference, currentBookmarkId: $currentBookmarkId, viewHistory: $viewHistory, highlightColor: $highlightColor, bookmarkById: $bookmarkById, annotations: $annotations, toolbar: $toolbar, passage: $passage, selection: $selection, searchHistory: $searchHistory)';
}
...
@useResult
$Res call({
 BibleTranslation translation, ChapterReference lastReference, String? currentBookmarkId, List<ChapterReference> viewHistory, ColorEnum highlightColor, Map<String, Bookmark> bookmarkById, List<Annotation> annotations, ToolbarConfiguration toolbar, PassageConfiguration passage, SelectionConfiguration selection, List<String> searchHistory
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( BibleTranslation translation,  ChapterReference lastReference,  String? currentBookmarkId,  List<ChapterReference> viewHistory,  ColorEnum highlightColor,  Map<String, Bookmark> bookmarkById,  List<Annotation> annotations,  ToolbarConfiguration toolbar,  PassageConfiguration passage,  SelectionConfiguration selection,  List<String> searchHistory)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.translation,_that.lastReference,_that.currentBookmarkId,_that.viewHistory,_that.highlightColor,_that.bookmarkById,_that.annotations,_that.toolbar,_that.passage,_that.selection,_that.searchHistory);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( BibleTranslation translation,  ChapterReference lastReference,  String? currentBookmarkId,  List<ChapterReference> viewHistory,  ColorEnum highlightColor,  Map<String, Bookmark> bookmarkById,  List<Annotation> annotations,  ToolbarConfiguration toolbar,  PassageConfiguration passage,  SelectionConfiguration selection,  List<String> searchHistory)  $default,) {final _that = this;
switch (_that) {
case _User():
return $default(_that.translation,_that.lastReference,_that.currentBookmarkId,_that.viewHistory,_that.highlightColor,_that.bookmarkById,_that.annotations,_that.toolbar,_that.passage,_that.selection,_that.searchHistory);}
}
