...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,translation,lastReference,currentBookmarkId,const DeepCollectionEquality().hash(viewHistory),highlightColor,const DeepCollectionEquality().hash(bookmarks),const DeepCollectionEquality().hash(annotations),toolbar,passage,selection,const DeepCollectionEquality().hash(searchHistory));

@override
String toString() {
  return 'User(translation: $translation, lastReference: $lastReference, currentBookmarkId: $currentBookmarkId, viewHistory: $viewHistory, highlightColor: $highlightColor, bookmarks: $bookmarks, annotations: $annotations, toolbar: $toolbar, passage: $passage, selection: $selection, searchHistory: $searchHistory)';
}
...
@useResult
$Res call({
 BibleTranslation translation, ChapterReference lastReference, String? currentBookmarkId, List<ChapterReference> viewHistory, ColorEnum highlightColor, List<Bookmark> bookmarks, List<Annotation> annotations, ToolbarConfiguration toolbar, PassageConfiguration passage, SelectionConfiguration selection, List<String> searchHistory
});
...
switch (_that) {
case _User() when $default != null:
return $default(_that.translation,_that.lastReference,_that.currentBookmarkId,_that.viewHistory,_that.highlightColor,_that.bookmarks,_that.annotations,_that.toolbar,_that.passage,_that.selection,_that.searchHistory);case _:
  return orElse();
...
switch (_that) {
case _User():
return $default(_that.translation,_that.lastReference,_that.currentBookmarkId,_that.viewHistory,_that.highlightColor,_that.bookmarks,_that.annotations,_that.toolbar,_that.passage,_that.selection,_that.searchHistory);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,translation,lastReference,currentBookmarkId,const DeepCollectionEquality().hash(_viewHistory),highlightColor,const DeepCollectionEquality().hash(_bookmarks),const DeepCollectionEquality().hash(_annotations),toolbar,passage,selection,const DeepCollectionEquality().hash(_searchHistory));
