...
@useResult
$Res call({
 BibleTranslation translation, BibleTranslation studyTranslation, BibleTranslation oldTestamentTranslation, BibleTranslation newTestamentTranslation, List<BibleTranslation>? bibles, List<CommentaryType>? commentaries,@ChapterPositionFromReference('lastReference') ChapterPosition lastPosition, String? currentBookmarkId,@ChapterPositionFromReference('viewHistory') List<ChapterPosition> viewHistory,@JsonKey(readValue: _readLastHighlightStyle) HighlightStyle lastHighlightStyle, Map<String, Bookmark> bookmarkById, List<Annotation> annotations, List<Notebook> notebooks, String? lastNotebookId, MainToolbarConfiguration mainToolbar, VerseSelectionConfiguration verseSelection, TextSelectionConfiguration textSelection, List<String> searchHistory, InterlinearDirection interlinearDirection, ThemeMode theme, ThemeLayoutConfiguration themeLayout, List<StudyPanel> studyPanels, int? studyPanelIndex, double studyPanelBottomPosition,@nullUnknownEnum Set<Tutorial?> tutorials, List<OnboardingStep>? completedOnboardingSteps, List<(HighlightStyle, String label)> highlightStyles, Map<BiblePlanType, BiblePlanProgress> planProgressByType, Set<BiblePlanType> completedPlans, AudioBibleConfiguration audio
});


$ChapterPositionCopyWith<$Res> get lastPosition;$HighlightStyleCopyWith<$Res> get lastHighlightStyle;$MainToolbarConfigurationCopyWith<$Res> get mainToolbar;$VerseSelectionConfigurationCopyWith<$Res> get verseSelection;$TextSelectionConfigurationCopyWith<$Res> get textSelection;$ThemeLayoutConfigurationCopyWith<$Res> get themeLayout;$AudioBibleConfigurationCopyWith<$Res> get audio;
...
/// Create a copy of User
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? translation = null,Object? studyTranslation = null,Object? oldTestamentTranslation = null,Object? newTestamentTranslation = null,Object? bibles = freezed,Object? commentaries = freezed,Object? lastPosition = null,Object? currentBookmarkId = freezed,Object? viewHistory = null,Object? lastHighlightStyle = null,Object? bookmarkById = null,Object? annotations = null,Object? notebooks = null,Object? lastNotebookId = freezed,Object? mainToolbar = null,Object? verseSelection = null,Object? textSelection = null,Object? searchHistory = null,Object? interlinearDirection = null,Object? theme = null,Object? themeLayout = null,Object? studyPanels = null,Object? studyPanelIndex = freezed,Object? studyPanelBottomPosition = null,Object? tutorials = null,Object? completedOnboardingSteps = freezed,Object? highlightStyles = null,Object? planProgressByType = null,Object? completedPlans = null,Object? audio = null,}) {
...
as List<OnboardingStep>?,highlightStyles: null == highlightStyles ? _self.highlightStyles : highlightStyles // ignore: cast_nullable_to_non_nullable
as List<(HighlightStyle, String label)>,planProgressByType: null == planProgressByType ? _self.planProgressByType : planProgressByType // ignore: cast_nullable_to_non_nullable
...
as Set<BiblePlanType>,audio: null == audio ? _self.audio : audio // ignore: cast_nullable_to_non_nullable
as AudioBibleConfiguration,
  ));
}
/// Create a copy of User
/// with the given fields replaced by the non-null parameter values.
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( BibleTranslation translation,  BibleTranslation studyTranslation,  BibleTranslation oldTestamentTranslation,  BibleTranslation newTestamentTranslation,  List<BibleTranslation>? bibles,  List<CommentaryType>? commentaries, @ChapterPositionFromReference('lastReference')  ChapterPosition lastPosition,  String? currentBookmarkId, @ChapterPositionFromReference('viewHistory')  List<ChapterPosition> viewHistory, @JsonKey(readValue: _readLastHighlightStyle)  HighlightStyle lastHighlightStyle,  Map<String, Bookmark> bookmarkById,  List<Annotation> annotations,  List<Notebook> notebooks,  String? lastNotebookId,  MainToolbarConfiguration mainToolbar,  VerseSelectionConfiguration verseSelection,  TextSelectionConfiguration textSelection,  List<String> searchHistory,  InterlinearDirection interlinearDirection,  ThemeMode theme,  ThemeLayoutConfiguration themeLayout,  List<StudyPanel> studyPanels,  int? studyPanelIndex,  double studyPanelBottomPosition, @nullUnknownEnum  Set<Tutorial?> tutorials,  List<OnboardingStep>? completedOnboardingSteps,  List<(HighlightStyle, String label)> highlightStyles,  Map<BiblePlanType, BiblePlanProgress> planProgressByType,  Set<BiblePlanType> completedPlans,  AudioBibleConfiguration audio)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.translation,_that.studyTranslation,_that.oldTestamentTranslation,_that.newTestamentTranslation,_that.bibles,_that.commentaries,_that.lastPosition,_that.currentBookmarkId,_that.viewHistory,_that.lastHighlightStyle,_that.bookmarkById,_that.annotations,_that.notebooks,_that.lastNotebookId,_that.mainToolbar,_that.verseSelection,_that.textSelection,_that.searchHistory,_that.interlinearDirection,_that.theme,_that.themeLayout,_that.studyPanels,_that.studyPanelIndex,_that.studyPanelBottomPosition,_that.tutorials,_that.completedOnboardingSteps,_that.highlightStyles,_that.planProgressByType,_that.completedPlans,_that.audio);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( BibleTranslation translation,  BibleTranslation studyTranslation,  BibleTranslation oldTestamentTranslation,  BibleTranslation newTestamentTranslation,  List<BibleTranslation>? bibles,  List<CommentaryType>? commentaries, @ChapterPositionFromReference('lastReference')  ChapterPosition lastPosition,  String? currentBookmarkId, @ChapterPositionFromReference('viewHistory')  List<ChapterPosition> viewHistory, @JsonKey(readValue: _readLastHighlightStyle)  HighlightStyle lastHighlightStyle,  Map<String, Bookmark> bookmarkById,  List<Annotation> annotations,  List<Notebook> notebooks,  String? lastNotebookId,  MainToolbarConfiguration mainToolbar,  VerseSelectionConfiguration verseSelection,  TextSelectionConfiguration textSelection,  List<String> searchHistory,  InterlinearDirection interlinearDirection,  ThemeMode theme,  ThemeLayoutConfiguration themeLayout,  List<StudyPanel> studyPanels,  int? studyPanelIndex,  double studyPanelBottomPosition, @nullUnknownEnum  Set<Tutorial?> tutorials,  List<OnboardingStep>? completedOnboardingSteps,  List<(HighlightStyle, String label)> highlightStyles,  Map<BiblePlanType, BiblePlanProgress> planProgressByType,  Set<BiblePlanType> completedPlans,  AudioBibleConfiguration audio)  $default,) {final _that = this;
switch (_that) {
case _User():
return $default(_that.translation,_that.studyTranslation,_that.oldTestamentTranslation,_that.newTestamentTranslation,_that.bibles,_that.commentaries,_that.lastPosition,_that.currentBookmarkId,_that.viewHistory,_that.lastHighlightStyle,_that.bookmarkById,_that.annotations,_that.notebooks,_that.lastNotebookId,_that.mainToolbar,_that.verseSelection,_that.textSelection,_that.searchHistory,_that.interlinearDirection,_that.theme,_that.themeLayout,_that.studyPanels,_that.studyPanelIndex,_that.studyPanelBottomPosition,_that.tutorials,_that.completedOnboardingSteps,_that.highlightStyles,_that.planProgressByType,_that.completedPlans,_that.audio);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( BibleTranslation translation,  BibleTranslation studyTranslation,  BibleTranslation oldTestamentTranslation,  BibleTranslation newTestamentTranslation,  List<BibleTranslation>? bibles,  List<CommentaryType>? commentaries, @ChapterPositionFromReference('lastReference')  ChapterPosition lastPosition,  String? currentBookmarkId, @ChapterPositionFromReference('viewHistory')  List<ChapterPosition> viewHistory, @JsonKey(readValue: _readLastHighlightStyle)  HighlightStyle lastHighlightStyle,  Map<String, Bookmark> bookmarkById,  List<Annotation> annotations,  List<Notebook> notebooks,  String? lastNotebookId,  MainToolbarConfiguration mainToolbar,  VerseSelectionConfiguration verseSelection,  TextSelectionConfiguration textSelection,  List<String> searchHistory,  InterlinearDirection interlinearDirection,  ThemeMode theme,  ThemeLayoutConfiguration themeLayout,  List<StudyPanel> studyPanels,  int? studyPanelIndex,  double studyPanelBottomPosition, @nullUnknownEnum  Set<Tutorial?> tutorials,  List<OnboardingStep>? completedOnboardingSteps,  List<(HighlightStyle, String label)> highlightStyles,  Map<BiblePlanType, BiblePlanProgress> planProgressByType,  Set<BiblePlanType> completedPlans,  AudioBibleConfiguration audio)?  $default,) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.translation,_that.studyTranslation,_that.oldTestamentTranslation,_that.newTestamentTranslation,_that.bibles,_that.commentaries,_that.lastPosition,_that.currentBookmarkId,_that.viewHistory,_that.lastHighlightStyle,_that.bookmarkById,_that.annotations,_that.notebooks,_that.lastNotebookId,_that.mainToolbar,_that.verseSelection,_that.textSelection,_that.searchHistory,_that.interlinearDirection,_that.theme,_that.themeLayout,_that.studyPanels,_that.studyPanelIndex,_that.studyPanelBottomPosition,_that.tutorials,_that.completedOnboardingSteps,_that.highlightStyles,_that.planProgressByType,_that.completedPlans,_that.audio);case _:
  return null;
...
class _User extends User {
  const _User({this.translation = BibleTranslation.bsb, this.studyTranslation = BibleTranslation.bsb, this.oldTestamentTranslation = BibleTranslation.oshb, this.newTestamentTranslation = BibleTranslation.statresgnt, final  List<BibleTranslation>? bibles, final  List<CommentaryType>? commentaries, @ChapterPositionFromReference('lastReference') this.lastPosition = const ChapterPosition(reference: ChapterReference(chapterNum: 1, book: BookType.genesis)), this.currentBookmarkId, @ChapterPositionFromReference('viewHistory') final  List<ChapterPosition> viewHistory = const [], @JsonKey(readValue: _readLastHighlightStyle) this.lastHighlightStyle = HighlightStyle.fallback, final  Map<String, Bookmark> bookmarkById = const {}, final  List<Annotation> annotations = const [], final  List<Notebook> notebooks = const [], this.lastNotebookId, this.mainToolbar = const MainToolbarConfiguration(), this.verseSelection = const VerseSelectionConfiguration(), this.textSelection = const TextSelectionConfiguration(), final  List<String> searchHistory = const [], this.interlinearDirection = InterlinearDirection.reverse, this.theme = ThemeMode.system, this.themeLayout = const ThemeLayoutConfiguration(), final  List<StudyPanel> studyPanels = const [], this.studyPanelIndex, this.studyPanelBottomPosition = 0.5, @nullUnknownEnum final  Set<Tutorial?> tutorials = const {}, final  List<OnboardingStep>? completedOnboardingSteps, final  List<(HighlightStyle, String label)> highlightStyles = HighlightStyle.defaultValues, final  Map<BiblePlanType, BiblePlanProgress> planProgressByType = const {}, final  Set<BiblePlanType> completedPlans = const {}, this.audio = const AudioBibleConfiguration()}): _bibles = bibles,_commentaries = commentaries,_viewHistory = viewHistory,_bookmarkById = bookmarkById,_annotations = annotations,_notebooks = notebooks,_searchHistory = searchHistory,_studyPanels = studyPanels,_tutorials = tutorials,_completedOnboardingSteps = completedOnboardingSteps,_highlightStyles = highlightStyles,_planProgressByType = planProgressByType,_completedPlans = completedPlans,super._();
...
@override List<OnboardingStep>? get completedOnboardingSteps {
 ...
 final  List<(HighlightStyle, String label)> _highlightStyles;
@override@JsonKey() List<(HighlightStyle, String label)> get highlightStyles {
  if (_highlightStyles is EqualUnmodifiableListView) return _highlightStyles;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_highlightStyles);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _User&&(identical(other.translation, translation) || other.translation == translation)&&(identical(other.studyTranslation, studyTranslation) || other.studyTranslation == studyTranslation)&&(identical(other.oldTestamentTranslation, oldTestamentTranslation) || other.oldTestamentTranslation == oldTestamentTranslation)&&(identical(other.newTestamentTranslation, newTestamentTranslation) || other.newTestamentTranslation == newTestamentTranslation)&&const DeepCollectionEquality().equals(other._bibles, _bibles)&&const DeepCollectionEquality().equals(other._commentaries, _commentaries)&&(identical(other.lastPosition, lastPosition) || other.lastPosition == lastPosition)&&(identical(other.currentBookmarkId, currentBookmarkId) || other.currentBookmarkId == currentBookmarkId)&&const DeepCollectionEquality().equals(other._viewHistory, _viewHistory)&&(identical(other.lastHighlightStyle, lastHighlightStyle) || other.lastHighlightStyle == lastHighlightStyle)&&const DeepCollectionEquality().equals(other._bookmarkById, _bookmarkById)&&const DeepCollectionEquality().equals(other._annotations, _annotations)&&const DeepCollectionEquality().equals(other._notebooks, _notebooks)&&(identical(other.lastNotebookId, lastNotebookId) || other.lastNotebookId == lastNotebookId)&&(identical(other.mainToolbar, mainToolbar) || other.mainToolbar == mainToolbar)&&(identical(other.verseSelection, verseSelection) || other.verseSelection == verseSelection)&&(identical(other.textSelection, textSelection) || other.textSelection == textSelection)&&const DeepCollectionEquality().equals(other._searchHistory, _searchHistory)&&(identical(other.interlinearDirection, interlinearDirection) || other.interlinearDirection == interlinearDirection)&&(identical(other.theme, theme) || other.theme == theme)&&(identical(other.themeLayout, themeLayout) || other.themeLayout == themeLayout)&&const DeepCollectionEquality().equals(other._studyPanels, _studyPanels)&&(identical(other.studyPanelIndex, studyPanelIndex) || other.studyPanelIndex == studyPanelIndex)&&(identical(other.studyPanelBottomPosition, studyPanelBottomPosition) || other.studyPanelBottomPosition == studyPanelBottomPosition)&&const DeepCollectionEquality().equals(other._tutorials, _tutorials)&&const DeepCollectionEquality().equals(other._completedOnboardingSteps, _completedOnboardingSteps)&&const DeepCollectionEquality().equals(other._highlightStyles, _highlightStyles)&&const DeepCollectionEquality().equals(other._planProgressByType, _planProgressByType)&&const DeepCollectionEquality().equals(other._completedPlans, _completedPlans)&&(identical(other.audio, audio) || other.audio == audio));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,translation,studyTranslation,oldTestamentTranslation,newTestamentTranslation,const DeepCollectionEquality().hash(_bibles),const DeepCollectionEquality().hash(_commentaries),lastPosition,currentBookmarkId,const DeepCollectionEquality().hash(_viewHistory),lastHighlightStyle,const DeepCollectionEquality().hash(_bookmarkById),const DeepCollectionEquality().hash(_annotations),const DeepCollectionEquality().hash(_notebooks),lastNotebookId,mainToolbar,verseSelection,textSelection,const DeepCollectionEquality().hash(_searchHistory),interlinearDirection,theme,themeLayout,const DeepCollectionEquality().hash(_studyPanels),studyPanelIndex,studyPanelBottomPosition,const DeepCollectionEquality().hash(_tutorials),const DeepCollectionEquality().hash(_completedOnboardingSteps),const DeepCollectionEquality().hash(_highlightStyles),const DeepCollectionEquality().hash(_planProgressByType),const DeepCollectionEquality().hash(_completedPlans),audio]);
...
as List<OnboardingStep>?,highlightStyles: null == highlightStyles ? _self._highlightStyles : highlightStyles // ignore: cast_nullable_to_non_nullable
as List<(HighlightStyle, String label)>,planProgressByType: null == planProgressByType ? _self._planProgressByType : planProgressByType // ignore: cast_nullable_to_non_nullable
