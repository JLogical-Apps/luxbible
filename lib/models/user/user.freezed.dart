...
mixin _$User {
 ...
 BibleTranslation get translation; ChapterReference get lastReference; String? get currentBookmarkId; List<ChapterReference> get viewHistory; ColorEnum get highlightColor; Map<String, Bookmark> get bookmarkById; List<Annotation> get annotations; ToolbarConfiguration get toolbar; PassageConfiguration get passage; SelectionConfiguration get selection; List<String> get searchHistory; InterlinearDirection get interlinearDirection;
...
@useResult
$Res call({
 BibleTranslation translation, ChapterReference lastReference, String? currentBookmarkId, List<ChapterReference> viewHistory, ColorEnum highlightColor, Map<String, Bookmark> bookmarkById, List<Annotation> annotations, ToolbarConfiguration toolbar, PassageConfiguration passage, SelectionConfiguration selection, List<String> searchHistory, InterlinearDirection interlinearDirection
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( BibleTranslation translation,  ChapterReference lastReference,  String? currentBookmarkId,  List<ChapterReference> viewHistory,  ColorEnum highlightColor,  Map<String, Bookmark> bookmarkById,  List<Annotation> annotations,  ToolbarConfiguration toolbar,  PassageConfiguration passage,  SelectionConfiguration selection,  List<String> searchHistory,  InterlinearDirection interlinearDirection)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.translation,_that.lastReference,_that.currentBookmarkId,_that.viewHistory,_that.highlightColor,_that.bookmarkById,_that.annotations,_that.toolbar,_that.passage,_that.selection,_that.searchHistory,_that.interlinearDirection);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( BibleTranslation translation,  ChapterReference lastReference,  String? currentBookmarkId,  List<ChapterReference> viewHistory,  ColorEnum highlightColor,  Map<String, Bookmark> bookmarkById,  List<Annotation> annotations,  ToolbarConfiguration toolbar,  PassageConfiguration passage,  SelectionConfiguration selection,  List<String> searchHistory,  InterlinearDirection interlinearDirection)  $default,) {final _that = this;
switch (_that) {
case _User():
return $default(_that.translation,_that.lastReference,_that.currentBookmarkId,_that.viewHistory,_that.highlightColor,_that.bookmarkById,_that.annotations,_that.toolbar,_that.passage,_that.selection,_that.searchHistory,_that.interlinearDirection);}
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _User&&(identical(other.translation, translation) || other.translation == translation)&&(identical(other.lastReference, lastReference) || other.lastReference == lastReference)&&(identical(other.currentBookmarkId, currentBookmarkId) || other.currentBookmarkId == currentBookmarkId)&&const DeepCollectionEquality().equals(other._viewHistory, _viewHistory)&&(identical(other.highlightColor, highlightColor) || other.highlightColor == highlightColor)&&const DeepCollectionEquality().equals(other._bookmarkById, _bookmarkById)&&const DeepCollectionEquality().equals(other._annotations, _annotations)&&(identical(other.toolbar, toolbar) || other.toolbar == toolbar)&&(identical(other.passage, passage) || other.passage == passage)&&(identical(other.selection, selection) || other.selection == selection)&&const DeepCollectionEquality().equals(other._searchHistory, _searchHistory)&&(identical(other.interlinearDirection, interlinearDirection) || other.interlinearDirection == interlinearDirection));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,translation,lastReference,currentBookmarkId,const DeepCollectionEquality().hash(_viewHistory),highlightColor,const DeepCollectionEquality().hash(_bookmarkById),const DeepCollectionEquality().hash(_annotations),toolbar,passage,selection,const DeepCollectionEquality().hash(_searchHistory),interlinearDirection);
