...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,translation,studyTranslation,audioTranslation,oldTestamentTranslation,newTestamentTranslation,const DeepCollectionEquality().hash(_bibles),const DeepCollectionEquality().hash(_commentaries),lastPosition,currentBookmarkId,const DeepCollectionEquality().hash(_viewHistory),lastHighlightStyle,const DeepCollectionEquality().hash(_bookmarkById),const DeepCollectionEquality().hash(_annotations),const DeepCollectionEquality().hash(_notebooks),lastNotebookId,mainToolbar,verseSelection,textSelection,const DeepCollectionEquality().hash(_searchHistory),interlinearDirection,theme,themeLayout,const DeepCollectionEquality().hash(_studyPanels),studyPanelIndex,studyPanelBottomPosition,const DeepCollectionEquality().hash(_tutorials),const DeepCollectionEquality().hash(_completedOnboardingSteps),const DeepCollectionEquality().hash(_highlightStyles),const DeepCollectionEquality().hash(_planProgressByType),const DeepCollectionEquality().hash(_completedPlans),audio]);
