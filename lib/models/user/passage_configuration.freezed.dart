...
mixin _$PassageConfiguration {
 ...
 PassageShortcut get pinnedShortcut1; PassageShortcut get pinnedShortcut2; PassageShortcut get pinnedShortcut3; bool get expandToAnnotation; bool get rangeSelection;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,pinnedShortcut1,pinnedShortcut2,pinnedShortcut3,expandToAnnotation,rangeSelection);

@override
String toString() {
  return 'PassageConfiguration(pinnedShortcut1: $pinnedShortcut1, pinnedShortcut2: $pinnedShortcut2, pinnedShortcut3: $pinnedShortcut3, expandToAnnotation: $expandToAnnotation, rangeSelection: $rangeSelection)';
}
...
@useResult
$Res call({
 PassageShortcut pinnedShortcut1, PassageShortcut pinnedShortcut2, PassageShortcut pinnedShortcut3, bool expandToAnnotation, bool rangeSelection
});
...
/// Create a copy of PassageConfiguration
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pinnedShortcut1 = null,Object? pinnedShortcut2 = null,Object? pinnedShortcut3 = null,Object? expandToAnnotation = null,Object? rangeSelection = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PassageShortcut pinnedShortcut1,  PassageShortcut pinnedShortcut2,  PassageShortcut pinnedShortcut3,  bool expandToAnnotation,  bool rangeSelection)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PassageConfiguration() when $default != null:
return $default(_that.pinnedShortcut1,_that.pinnedShortcut2,_that.pinnedShortcut3,_that.expandToAnnotation,_that.rangeSelection);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PassageShortcut pinnedShortcut1,  PassageShortcut pinnedShortcut2,  PassageShortcut pinnedShortcut3,  bool expandToAnnotation,  bool rangeSelection)  $default,) {final _that = this;
switch (_that) {
case _PassageConfiguration():
return $default(_that.pinnedShortcut1,_that.pinnedShortcut2,_that.pinnedShortcut3,_that.expandToAnnotation,_that.rangeSelection);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PassageShortcut pinnedShortcut1,  PassageShortcut pinnedShortcut2,  PassageShortcut pinnedShortcut3,  bool expandToAnnotation,  bool rangeSelection)?  $default,) {final _that = this;
switch (_that) {
case _PassageConfiguration() when $default != null:
return $default(_that.pinnedShortcut1,_that.pinnedShortcut2,_that.pinnedShortcut3,_that.expandToAnnotation,_that.rangeSelection);case _:
  return null;
...
class _PassageConfiguration extends PassageConfiguration {
  const _PassageConfiguration({this.pinnedShortcut1 = PassageShortcut.annotate, this.pinnedShortcut2 = PassageShortcut.commentary, this.pinnedShortcut3 = PassageShortcut.interlinear, this.expandToAnnotation = false, this.rangeSelection = false}): super._();
...
/// Create a copy of PassageConfiguration
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? pinnedShortcut1 = null,Object? pinnedShortcut2 = null,Object? pinnedShortcut3 = null,Object? expandToAnnotation = null,Object? rangeSelection = null,}) {
