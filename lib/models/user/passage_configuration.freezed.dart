...
mixin _$PassageConfiguration {
 ...
 PassageShortcut get pinnedShortcut1; PassageShortcut get pinnedShortcut2; PassageShortcut get pinnedShortcut3; PassageShortcut get longPressShortcut; bool get expandToAnnotation; bool get rangeSelection;
...
@override
String toString() {
  return 'PassageConfiguration(pinnedShortcut1: $pinnedShortcut1, pinnedShortcut2: $pinnedShortcut2, pinnedShortcut3: $pinnedShortcut3, longPressShortcut: $longPressShortcut, expandToAnnotation: $expandToAnnotation, rangeSelection: $rangeSelection)';
}
...
@useResult
$Res call({
 PassageShortcut pinnedShortcut1, PassageShortcut pinnedShortcut2, PassageShortcut pinnedShortcut3, PassageShortcut longPressShortcut, bool expandToAnnotation, bool rangeSelection
});
...
as PassageShortcut,longPressShortcut: null == longPressShortcut ? _self.longPressShortcut : longPressShortcut // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PassageShortcut pinnedShortcut1,  PassageShortcut pinnedShortcut2,  PassageShortcut pinnedShortcut3,  PassageShortcut longPressShortcut,  bool expandToAnnotation,  bool rangeSelection)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PassageConfiguration() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PassageShortcut pinnedShortcut1,  PassageShortcut pinnedShortcut2,  PassageShortcut pinnedShortcut3,  PassageShortcut longPressShortcut,  bool expandToAnnotation,  bool rangeSelection)  $default,) {final _that = this;
switch (_that) {
case _PassageConfiguration():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PassageShortcut pinnedShortcut1,  PassageShortcut pinnedShortcut2,  PassageShortcut pinnedShortcut3,  PassageShortcut longPressShortcut,  bool expandToAnnotation,  bool rangeSelection)?  $default,) {final _that = this;
switch (_that) {
case _PassageConfiguration() when $default != null:
return $default(_that.pinnedShortcut1,_that.pinnedShortcut2,_that.pinnedShortcut3,_that.longPressShortcut,_that.expandToAnnotation,_that.rangeSelection);case _:
  return null;
...
class _PassageConfiguration extends PassageConfiguration {
  const _PassageConfiguration({this.pinnedShortcut1 = PassageShortcut.annotate, this.pinnedShortcut2 = PassageShortcut.commentary, this.pinnedShortcut3 = PassageShortcut.interlinear, this.longPressShortcut = PassageShortcut.crossReferences, this.expandToAnnotation = false, this.rangeSelection = true}): super._();
...
@override@JsonKey() final  PassageShortcut longPressShortcut;
