...
mixin _$SelectionConfiguration {
 ...
 SelectionShortcut get pinnedShortcut1; SelectionShortcut get pinnedShortcut2; SelectionShortcut get pinnedShortcut3; bool get expandToAnnotation;
...
@override
String toString() {
  return 'SelectionConfiguration(pinnedShortcut1: $pinnedShortcut1, pinnedShortcut2: $pinnedShortcut2, pinnedShortcut3: $pinnedShortcut3, expandToAnnotation: $expandToAnnotation)';
}
...
@useResult
$Res call({
 SelectionShortcut pinnedShortcut1, SelectionShortcut pinnedShortcut2, SelectionShortcut pinnedShortcut3, bool expandToAnnotation
});
...
as SelectionShortcut,expandToAnnotation: null == expandToAnnotation ? _self.expandToAnnotation : expandToAnnotation // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SelectionShortcut pinnedShortcut1,  SelectionShortcut pinnedShortcut2,  SelectionShortcut pinnedShortcut3,  bool expandToAnnotation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SelectionConfiguration() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SelectionShortcut pinnedShortcut1,  SelectionShortcut pinnedShortcut2,  SelectionShortcut pinnedShortcut3,  bool expandToAnnotation)  $default,) {final _that = this;
switch (_that) {
case _SelectionConfiguration():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SelectionShortcut pinnedShortcut1,  SelectionShortcut pinnedShortcut2,  SelectionShortcut pinnedShortcut3,  bool expandToAnnotation)?  $default,) {final _that = this;
switch (_that) {
case _SelectionConfiguration() when $default != null:
return $default(_that.pinnedShortcut1,_that.pinnedShortcut2,_that.pinnedShortcut3,_that.expandToAnnotation);case _:
  return null;
...
class _SelectionConfiguration extends SelectionConfiguration {
  const _SelectionConfiguration({this.pinnedShortcut1 = SelectionShortcut.annotate, this.pinnedShortcut2 = SelectionShortcut.search, this.pinnedShortcut3 = SelectionShortcut.copy, this.expandToAnnotation = false}): super._();
