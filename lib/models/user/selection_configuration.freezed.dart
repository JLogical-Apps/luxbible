...
mixin _$SelectionConfiguration {
 ...
 SelectionShortcut get pinnedShortcut1; SelectionShortcut get pinnedShortcut2;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SelectionConfiguration&&(identical(other.pinnedShortcut1, pinnedShortcut1) || other.pinnedShortcut1 == pinnedShortcut1)&&(identical(other.pinnedShortcut2, pinnedShortcut2) || other.pinnedShortcut2 == pinnedShortcut2));
}
...
@override
String toString() {
  return 'SelectionConfiguration(pinnedShortcut1: $pinnedShortcut1, pinnedShortcut2: $pinnedShortcut2)';
}
...
@useResult
$Res call({
 SelectionShortcut pinnedShortcut1, SelectionShortcut pinnedShortcut2
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SelectionShortcut pinnedShortcut1,  SelectionShortcut pinnedShortcut2)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SelectionConfiguration() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SelectionShortcut pinnedShortcut1,  SelectionShortcut pinnedShortcut2)  $default,) {final _that = this;
switch (_that) {
case _SelectionConfiguration():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SelectionShortcut pinnedShortcut1,  SelectionShortcut pinnedShortcut2)?  $default,) {final _that = this;
switch (_that) {
case _SelectionConfiguration() when $default != null:
return $default(_that.pinnedShortcut1,_that.pinnedShortcut2);case _:
  return null;
...
class _SelectionConfiguration extends SelectionConfiguration {
  const _SelectionConfiguration({this.pinnedShortcut1 = SelectionShortcut.annotate, this.pinnedShortcut2 = SelectionShortcut.copy}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SelectionConfiguration&&(identical(other.pinnedShortcut1, pinnedShortcut1) || other.pinnedShortcut1 == pinnedShortcut1)&&(identical(other.pinnedShortcut2, pinnedShortcut2) || other.pinnedShortcut2 == pinnedShortcut2));
}
