...
_Strong _$StrongFromJson(Map<String, dynamic> json) => _Strong(
  ...
  definition: Markdown.fromJson(json['d'] as String),
  description: Markdown.fromJson(json['s'] as String),
...
Map<String, dynamic> _$StrongToJson(_Strong instance) => <String, dynamic>{
  ...
  'd': Markdown.toJson(instance.definition),
  's': Markdown.toJson(instance.description),
