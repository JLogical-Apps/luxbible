...
sealed class Strong with _$Strong {
  ...
  const factory Strong({
    ...
    @JsonKey(name: 'd', toJson: Markdown.toJson, fromJson: Markdown.fromJson) required Markdown usage,
    @JsonKey(name: 's', toJson: Markdown.toJson, fromJson: Markdown.fromJson) required Markdown definition,
  ...
  Markdown get formattedDefinition => definition.withStrongDefinitionFormatting;

  Markdown get formattedUsage => usage.withMorphologyLinks;
}
