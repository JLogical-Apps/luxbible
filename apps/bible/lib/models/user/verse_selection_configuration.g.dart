...
_VerseSelectionConfiguration _$VerseSelectionConfigurationFromJson(
  ...
  pinnedShortcut1:
      $enumDecodeNullable(_$VerseSelectionShortcutEnumMap, json['pinnedShortcut1']) ?? VerseSelectionShortcut.annotate,
  pinnedShortcut2:
      $enumDecodeNullable(_$VerseSelectionShortcutEnumMap, json['pinnedShortcut2']) ??
      VerseSelectionShortcut.commentary,
  pinnedShortcut3:
      $enumDecodeNullable(_$VerseSelectionShortcutEnumMap, json['pinnedShortcut3']) ?? VerseSelectionShortcut.compare,
  longPressShortcut:
      $enumDecodeNullable(_$VerseSelectionShortcutEnumMap, json['longPressShortcut']) ??
...
Map<String, dynamic> _$VerseSelectionConfigurationToJson(_VerseSelectionConfiguration instance) => <String, dynamic>{
  ...
  'longPressShortcut': _$VerseSelectionShortcutEnumMap[instance.longPressShortcut]!,
