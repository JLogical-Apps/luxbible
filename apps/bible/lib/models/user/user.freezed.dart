...
as List<(HighlightStyle, String,)>?,planProgressById: null == planProgressById ? _self.planProgressById : planProgressById // ignore: cast_nullable_to_non_nullable
as Map<String, BiblePlanProgress>,completedPlans: null == completedPlans ? _self.completedPlans : completedPlans // ignore: cast_nullable_to_non_nullable
as Set<String>,verseOfTheDayReminder: freezed == verseOfTheDayReminder ? _self.verseOfTheDayReminder : verseOfTheDayReminder // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( BibleTranslation translation,  BibleTranslation studyTranslation,  BibleTranslation audioTranslation,  BibleTranslation oldTestamentTranslation,  BibleTranslation newTestamentTranslation, @JsonKey(name: 'bibles')  List<BibleTranslation>? compareBibles,  List<BibleTranslation> recentBibles,  List<CommentaryType>? commentaries, @ChapterPositionFromReference('lastReference')  ChapterPosition lastPosition,  String? currentBookmarkId, @ChapterPositionFromReference('viewHistory')  List<ChapterPosition> viewHistory, @JsonKey(readValue: _readLastHighlightStyle)  HighlightStyle lastHighlightStyle,  Map<String, Bookmark> bookmarkById,  List<Annotation> annotations,  List<Notebook> notebooks,  String? lastNotebookId,  MainToolbarConfiguration mainToolbar,  VerseSelectionConfiguration verseSelection,  TextSelectionConfiguration textSelection,  List<String> searchHistory,  InterlinearDirection interlinearDirection,  ThemeMode theme,  ThemeLayoutConfiguration themeLayout,  List<StudyPanel> studyPanels,  int? studyPanelIndex,  double studyPanelBottomPosition, @nullUnknownEnum  Set<Tutorial?> tutorials,  List<OnboardingStep>? completedOnboardingSteps, @JsonKey(name: 'highlightStyles')  List<(HighlightStyle, String,)>? highlightStyleOverrides, @JsonKey(name: 'planProgressByType')  Map<String, BiblePlanProgress> planProgressById,  Set<String> completedPlans,  Reminder? verseOfTheDayReminder,  AudioBibleConfiguration audio,  Migration? latestMigration,  Set<Message> messages,  int activeDayCount,  CalendarDateTime? lastActiveDate,  bool hasRequestedReview)  $default,) {final _that = this;
switch (_that) {
case _User():
...
@override@JsonKey(name: 'highlightStyles') List<(HighlightStyle, String,)>? get highlightStyleOverrides {
 ...
 final  Map<String, BiblePlanProgress> _planProgressById;
@override@JsonKey(name: 'planProgressByType') Map<String, BiblePlanProgress> get planProgressById {
  if (_planProgressById is EqualUnmodifiableMapView) return _planProgressById;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_planProgressById);
}

 final  Set<String> _completedPlans;
@override@JsonKey() Set<String> get completedPlans {
...
as List<(HighlightStyle, String,)>?,planProgressById: null == planProgressById ? _self._planProgressById : planProgressById // ignore: cast_nullable_to_non_nullable
as Map<String, BiblePlanProgress>,completedPlans: null == completedPlans ? _self._completedPlans : completedPlans // ignore: cast_nullable_to_non_nullable
as Set<String>,verseOfTheDayReminder: freezed == verseOfTheDayReminder ? _self.verseOfTheDayReminder : verseOfTheDayReminder // ignore: cast_nullable_to_non_nullable
as Reminder?,audio: null == audio ? _self.audio : audio // ignore: cast_nullable_to_non_nullable
as AudioBibleConfiguration,latestMigration: freezed == latestMigration ? _self.latestMigration : latestMigration // ignore: cast_nullable_to_non_nullable
