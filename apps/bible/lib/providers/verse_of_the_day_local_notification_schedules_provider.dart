...
Future<List<LocalNotification>> verseOfTheDayLocalNotifications(Ref ref) async {
  ...
  final horizon = await resolveVerseOfTheDayHorizon(
    ref,
    start: time.getNextNotificationDate(),
    count: verseOfTheDayNotificationHorizonDays,
  );

  return horizon
      .mapToIterable(
        (date, verseOfTheDay) => LocalNotification(
