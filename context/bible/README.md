...
| What metadata and copy are pending for the Apple App Store? | [`appstore/`](appstore/) |
| What metadata and copy are pending for the Google Play Store? | [`play_store/`](play_store/) |
...
- The store directories contain pending metadata and copy organized by language code. They do not necessarily match the currently published listings.
