...
- Lux Bible's rendering widgets live in `apps/bible` because they integrate with Bible-specific user settings, translation fallback, annotations, selections, and study behavior.
