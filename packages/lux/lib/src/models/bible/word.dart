import 'package:lux/src/models/bible/interlinear_data.dart';
...
sealed class Word with _$Word {
  const factory Word({
    ...
    @JsonKey(name: 'r', toJson: _onlyIfTrue, includeIfNull: false)
    @Default(false)
    bool redLetters,
    @JsonKey(name: 'i', toJson: _onlyIfTrue, includeIfNull: false)
    @Default(false)
    bool italic,
  }) = _Word;
