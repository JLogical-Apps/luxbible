...
@useResult
$Res call({
@JsonKey(name: 'p') List<Paragraph> paragraphs
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'p')  List<Paragraph> paragraphs)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Chapter() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'p')  List<Paragraph> paragraphs)  $default,) {final _that = this;
switch (_that) {
case _Chapter():
return $default(_that.paragraphs);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'p')  List<Paragraph> paragraphs)?  $default,) {final _that = this;
switch (_that) {
case _Chapter() when $default != null:
return $default(_that.paragraphs);case _:
  return null;
...
class _Chapter extends Chapter {
   _Chapter({@JsonKey(name: 'p') required  List<Paragraph> paragraphs}): _paragraphs = paragraphs,super._();
  factory _Chapter.fromJson(Map<String, dynamic> json) => _$ChapterFromJson(json);

 final  List<Paragraph> _paragraphs;
@override@JsonKey(name: 'p') List<Paragraph> get paragraphs {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Chapter&&const DeepCollectionEquality().equals(other._paragraphs, _paragraphs));
}
