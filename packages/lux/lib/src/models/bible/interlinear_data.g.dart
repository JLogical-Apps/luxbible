...
_InterlinearData _$InterlinearDataFromJson(Map<String, dynamic> json) => _InterlinearData(
...
Map<String, dynamic> _$InterlinearDataToJson(_InterlinearData instance) => <String, dynamic>{
